...
void BNLJoin::combineRecords(void* data)
{
    ...
    cout << "int indicator: " <<(int)*(char*)nullIndicator << endl;
    //get the right attributes
    ...
    cout << "data indicator: " << (int)*(char*)nNullIndicator << endl;    
    char* rNullIndicator = (char*)rRecord;
    cout << "int indiaaaaa2: " << (int)*(char*)rNullIndicator << endl;
    cout << "comb3" << endl;
    for(int i = 0; i<nAttrNum; i++)
    {
    ...
    cout << "null ind: " << (int)*(char*)nNullIndicator << endl;
...
int BNLJoin::isValid()
{
    ...
    cout << "herehere is here" <<endl;
    free(newKey);
    cout << "free New Key" << endl;
    return 0;
}
